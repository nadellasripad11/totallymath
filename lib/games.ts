...
export const GAMES: Game[] = [
  ...
  g("slime-volleyball", "Slime Volleyball", "The legendary 2-player volleyball. You vs a friend on one keyboard — first to 7 wins.", ["new", "popular", "sports"], "/games/slime-volleyball/index.html", { featured: true, selfHosted: true }),
  g("archery", "Archery", "Draw the bow, judge the wind, and nail the bullseye. Beat your best score.", ["new", "popular", "arcade", "sports"], "/games/archery/index.html", { featured: true, selfHosted: true }),
  g("retro-breakout", "Retro Ball", "Retro brick-breaker. Bounce the ball, smash every block, don't let it drop.", ["new", "popular", "arcade"], "/games/retro-breakout/index.html", { featured: true, selfHosted: true }),
